...
class EncryptedSocketConnection {
    ...
    EncryptedSocketConnection(Socket connection, String key) throws IOException {
    ...
    void send(String plain) throws IOException {
    ...
    void showEncryptedMessages(boolean value) {
